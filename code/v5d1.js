...
window.onload = function init()
{
    ...
    window.addEventListener("keydown", function(e){
        switch( e.keyCode ) {
            case 48:
                view = 0;
                document.getElementById("Viewpoint").innerHTML = "0: Augað er í fastri hæð sem hægt er að færa með örvatökkum.";
                break;
            ...
            case 56:	// 8: from beside the car
                ...
                break;
            case 57:	// 9: from house at -40,140 looking at car
                view = 9;
                document.getElementById("Viewpoint").innerHTML = "9: Augað er ofan á húsinu sem er í hnitum (-40, 140) og horfir alltaf á bílinn.";
                break;
...
function render()
{
    ...
    switch( view ) {
    case 0:
        // Augað er í fastri hæð og hægt að færa með örvatökkum
        mv = lookAt( vec3(200.0, 0.0, 5.0+height), vec3(0.0, 0.0, 0.0), vec3(0.0, 0.0, 1.0 ) );
	    drawScenery( mv );
	...
	case 8:
	    ...
	    break;
	case 9:
        // Augað er ofan á húsinu sem er í hnitum (-40, 140) og horfir alltaf á bílinn.
        mv = lookAt( vec3(40.0, 140.0, 50.0+height), vec3(carXPos, carYPos, 0.0), vec3(0.0, 0.0, 1.0 ) );
	    drawScenery( mv );
	    mv = mult( mv, translate(carXPos, carYPos, 0.0) );
	    mv = mult( mv, rotateZ( -carDirection ) ) ;
	    drawCar( mv );
